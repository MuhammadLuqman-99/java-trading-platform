...
class KafkaEventPublisherTest {
    ...
    void shouldPublishWithRequiredHeadersAndKey() throws Exception {
        ...
        KafkaEventPublisher publisher = new KafkaEventPublisher(kafkaTemplate, codec, new NoOpKafkaTelemetry());
        ...
        assertEquals(EventHeaders.APPLICATION_JSON, headerValue(actualRecord, EventHeaders.CONTENT_TYPE));
    }
